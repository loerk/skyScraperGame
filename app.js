...
let Game = /** @class */ (function () {
    ...
    Game.prototype.placeBlock = function () {
        ...
        if (newBlocks.chopped) {
            ...
            let positionParams = { y: '-=30', ease: Power1.easeIn, onComplete: function () { return _this.choppedBlocks.remove(newBlocks.chopped); } };
